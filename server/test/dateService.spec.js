...
const startTime = new Date("March 26, 2020 14:00:00 UTC+1");
const endTime = new Date("March 26, 2020 15:00:00 UTC+1");
...
describe("extractDate given no start time", function() {
  it("should return a description, start and end times", function() {
    ...
    // work around to avoid the difference in seconds ...
    assert.startsWith(
      returnedObj_2.startTime,
      testObj_2.startTime.substr(0, 18)
    );
...
describe("extractDate given no end time", function() {
  it("should return a description, start and end times", function() {
    ...
    // work around to avoid the difference in seconds ...
    assert.startsWith(
      returnedObj_3.startTime,
      testObj_3.startTime.substr(0, 18)
    );
...
describe("extractDate given any input", function() {
  it("should return description, start and end time", function() {
    ...
    // work around to avoid the difference in seconds ...
    assert.startsWith(
      returnedObj_4.startTime,
      testObj_4.startTime.substr(0, 18)
    );
