...
describe('PreferencesScreen: Shallow Render Component', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<PreferencesScreen calendar={calendar} settings={settings} security={security} />, {
  ...
  it('calls componentDidMount', async () => {
    const mockGetCalendars = jest.fn().mockImplementation(() => [{ title: 'Mock-Calendar-1', id: 1 }]);
